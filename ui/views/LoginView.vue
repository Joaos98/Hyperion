...
async function submit(): Promise<void> {
  ...
  busy.value = true
  try {
    const user = await login(displayName.value.trim(), password.value)
...
<template>
  <div class="card">
    ...
    <form class="form" @submit.prevent="submit">
      <label>Display name <input v-model="displayName" type="text" required autofocus autocomplete="username" /></label>
    ...
    <p class="hint">Invited? <RouterLink to="/register">Use your invite</RouterLink> instead.</p>
  </div>
</template>
